            ...
            <div className='grid lg:grid-cols-[400px_1fr] gap-8'>
              ...
              <div className={`space-y-6 ${id && 'pointer-events-none'}`}>
                <div className='p-6 rounded-2xl bg-white/8 border border-white/12 shadow-xl space-y-6'>
                  ...
                  <div className='space-y-5'>
                   ...
                   {/* AspectRatioSelector */}
                    <AspectRatioSelector value={aspectRatio} onChange={setAspectRatio}></AspectRatioSelector>
                  
                   {/* StyleSelector */}
                    <StyleSelector value={style} onChange={setStyle} isOpen={styleDropdownOpen} setIsOpen={setStyleDropdownOpen}></StyleSelector>

                   {/* ColorSchemeSelector */}
                    <ColorSchemeSelector value={colorSchemeId} onChange={setColorSchemeId}></ColorSchemeSelector>
                   ...
                   <div className='space-y-2'>
                    ...
                    <textarea name="" id="" value={additionalDetails} onChange={(e) => setAdditionalDetails(e.target.value)} rows={3} placeholder='Add any specific elements, mood, or style preferences...' className='w-full px-4 py-3 rounded-lg border border-white/10 bg-white/6 text-zinc-100 placeholder:text-zinc-400 focus:outline-none focus:rind-2 focus:ring-pink-500 resize-none'></textarea>
                   </div>
                  </div>
              ...
              <div>
                <div className='p-6 rounded-2xl bg-white/8 border border-white/10 shadow-xl'>
                    ...
                    <PreviewPanel thumbnail={thumbnail} isLoading={loading} aspectRatio={aspectRatio}></PreviewPanel>
                </div>
              </div>
            </div>
        </main>
