...
const AspectRatioSelector = ({value, onChange} : {value: AspectRatio; onChange: (ratio: AspectRatio) => void}) => {
    ...
    const iconMap = {
        ...
        '1:1' : <Square className='size-6'></Square>,
        '9:16' : <RectangleVertical className='size-6'></RectangleVertical>,
        
    } as Record<AspectRatio, React.ReactNode>

  return (
    <div className='space-y-3 dark'>
        <label className='block text-sm font-medium text-zinc-200' htmlFor="">Aspect Ratio</label>
