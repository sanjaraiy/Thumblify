...
const StyleSelector = ({value, onChange, isOpen, setIsOpen} : {
  ...
  const styleIcons: Record<ThumbnailStyle, React.ReactNode> = {
    "Bold & Graphic" : <SparkleIcon className='h-4 w-4'></SparkleIcon>,
    "Minimalist" : <SquareIcon className='h-4 w-4'></SquareIcon>,
    "Photorealistic": <ImageIcon className='h-4 w-4'></ImageIcon>,
    "Illustrated": <PenToolIcon className='h-4 w-4'></PenToolIcon>,
    "Tech/Futuristic": <CpuIcon className='h-4 w-4'></CpuIcon>,
  }
